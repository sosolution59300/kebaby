...
@RestController
@RequestMapping("/api/kebaby-kafka")
public class KebabyKafkaResource {

    private final Logger log = LoggerFactory.getLogger(KebabyKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public KebabyKafkaResource(KafkaProperties kafkaProperties) {
